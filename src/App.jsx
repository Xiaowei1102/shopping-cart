  ...
  return (
    <>
      ...
      <div className='homeImages men'>
        <img src="/front1.jpg" alt="home image man1" />
        <img src="/front2.jpg" alt="home image man2" />
        <img src="/front3.jpg" alt="home image man3" />
      </div>
      <div className='womenTitle'>WOMEN</div>
      <div className='homeImages women'>
        <img src="/front4.jpg" alt="home image woman1" />
        <img src="/front5.jpg" alt="home image woman2" />
        <img src="/front6.jpg" alt="home image woman3" />
      </div>
